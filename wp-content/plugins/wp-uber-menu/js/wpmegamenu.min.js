...
!1)},interval:b,timeout:500,sensitivity:2});$u(".wpmega-nonlink.wpmega-widgetarea li:last-child").addClass("wpmega-last-child")}function wpmega_showMega(b){megaMenuCloseAllSubMenus(b);$u(b).addClass("megaHover");var a=$u(b).find("ul.sub-menu-1");$u(b).hasClass("ss-nav-menu-mega")&&!a.hasClass("megaMenu-calc")&&wpmega_setupMegaSubMenu($u(b),a);$u.wpmega.trans=="fade"?a.show():a.slideDown()}
function wpmega_showReg(b){$u(b).hasClass("ss-nav-menu-reg")?megaMenuCloseAllSubMenus(b):$u(b).siblings().each(function(){megaMenuCloseSubMenu($u(this),!0)});$u(b).addClass("megaHover");var a=$u(b).find("> ul.sub-menu");$u.wpmega.trans=="fade"?a.show():a.slideDown();if($u(b).parents("#megaMenu").hasClass("megaMenuHorizontal")){if(a.size()>0&&$u(b).hasClass("ss-nav-menu-reg")&&!$u(b).hasClass("megaMenu-calc")){borderWidthTop=parseInt(a.css("border-bottom-width"));borderWidthBot=parseInt(a.css("border-top-width"));
