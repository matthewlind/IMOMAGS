...
function wpMegaMenu_init(){$u("#megaMenu.wpmega-noconflict ul, #megaMenu.wpmega-noconflict ul li, #megaMenu.wpmega-noconflict ul li a").removeAttr("style").unbind();$u("#megaMenu").removeClass("megaMenu-nojs").addClass("megaMenu-withjs");$u("#megaMenu > ul > li:has(ul)").addClass("mega-with-sub");$u("#megaMenu li.ss-nav-menu-reg li:has(ul)").addClass("megaReg-with-sub");$u("#megaMenu").hasClass("megaMenuFade");var b=wpmegasettings&&wpmegasettings.hoverinterval!=null?wpmegasettings.hoverinterval:0,
...
!1)},interval:b,timeout:0,sensitivity:1});$u(".wpmega-nonlink.wpmega-widgetarea li:last-child").addClass("wpmega-last-child")}function wpmega_showMega(b){megaMenuCloseAllSubMenus(b);$u(b).addClass("megaHover");var a=$u(b).find("ul.sub-menu-1");$u(b).hasClass("ss-nav-menu-mega")&&!a.hasClass("megaMenu-calc")&&wpmega_setupMegaSubMenu($u(b),a);$u.wpmega.trans=="fade"?a.show():a.show()}
function wpmega_showReg(b){$u(b).hasClass("ss-nav-menu-reg")?megaMenuCloseAllSubMenus(b):$u(b).siblings().each(function(){megaMenuCloseSubMenu($u(this),!0)});$u(b).addClass("megaHover");var a=$u(b).find("> ul.sub-menu");$u.wpmega.trans=="fade"?a.show():a.show();if($u(b).parents("#megaMenu").hasClass("megaMenuHorizontal")){if(a.size()>0&&$u(b).hasClass("ss-nav-menu-reg")&&!$u(b).hasClass("megaMenu-calc")){borderWidthTop=parseInt(a.css("border-bottom-width"));borderWidthBot=parseInt(a.css("border-top-width"));
...
1,width:maxW,top:d,bottom:h});a.addClass("megaMenu-calc")}function megaMenuCloseSubMenu(b,a){var c=b.find("> ul.sub-menu");a?(c.hide(),b.removeClass("megaHover").removeClass("wpmega-expanded")):c.size()>0?$u.wpmega.trans=="fade"?c.hide(0,function(){b.removeClass("megaHover").removeClass("wpmega-expanded")}):c.hide(0,function(){b.removeClass("megaHover").removeClass("wpmega-expanded")}):b.removeClass("megaHover").removeClass("wpmega-expanded")}
