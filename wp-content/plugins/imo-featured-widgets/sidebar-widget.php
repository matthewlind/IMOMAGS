...
class imo_featured_2_sidebar_widget extends WP_Widget {


    /** constructor -- name this the same as the class above */
    function imo_featured_2_sidebar_widget() {
        parent::WP_Widget(false, $name = 'Featured Posts (Full-Width Thumbnail)');
    }
    ...
    function form($instance) {
        ...
        function getWidgetThumbnail2($dataArray) {
...
add_action('widgets_init', create_function('', 'return register_widget("imo_featured_2_sidebar_widget");'));
