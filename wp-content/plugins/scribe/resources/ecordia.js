...
function ecordia(ecordia_dependency, ecordia_element_title, ecordia_element_description){
    	...
    	jQuery.post(
    		...
    		function(data,status) {
    			...
    			if(data.error == 1) {
    				...
    				tb_show('Scribe Keyword Research', 'media-upload.php?tab=ecordia-keyword-research&phrase='+encodeURIComponent(data.phrase)+'&match-type='+encodeURIComponent(data.match)+'&TB_iframe=true', false);
    			}
    		},
    		'json'
		);
