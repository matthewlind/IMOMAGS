...
function jsGAMRender($mobile) {
  ...
  if($mobile) { // If it's a mobile device //
	...
	$outp.= '<div id="madtabs">'
		 ...
		 .  '    <div>'. get_imo_dart_tag("240x60",1,false,array("sect" => "","camp"=>"handgunsmadness")) .'</div>'
		 .  '    <div class="mreg1"></div>'
		 .  '    <h2 id="rifles">Crossbows</h2>'
		 .  '    <div>'. get_imo_dart_tag("240x60",1,false,array("sect" => "","camp"=>"riflesmadness")) .'</div>'
		 .  '    <div class="mreg3"></div>'
		 .  '    <h2 id="ar15s">Compound</h2>'
		 .  '    <div>'. get_imo_dart_tag("240x60",1,false,array("sect" => "","camp"=>"arsmadness")) .'</div>'
		 .  '    <div class="mreg4"></div>'
	...
	$outp.= '<div class="ga-madness-votestats" style="margin-bottom:20px;clear:both;"></div>'
		 ...
		 .	'	<div id="div-gpt-ad-1438179181782-0" >'
	...
	$outp.= '<div class="ga-madness">'
		 ...
		 .	'		<div id="div-gpt-ad-1438179181782-1" >'
		 .	'			<script type="text/javascript">'
		 .	'				googletag.cmd.push(function() { googletag.display("div-gpt-ad-1438179181782-1"); });'
		 .	'			</script>'
		 .	'		</div>'
		 .	'  </div>'
		 ...
		 .	'		<!-- Site - Guns and Ammo/guns_and_ammo_madness/gam_region_sponsor_2 -->'
	 	 .	'		<div id="div-gpt-ad-1438179181782-2" >'
	 	 .	'			<script type="text/javascript">'
	 	 .	'				googletag.cmd.push(function() { googletag.display("div-gpt-ad-1438179181782-2"); });'
	 	 .	'			</script>'
	 	 .	'		</div>'
		 .	'  </div>'
		 .	'</div>'
	...
	$outp.= '<div class="regions region-final">'
		 ...
		 .	'		<div id="div-gpt-ad-1438179181782-1" style="width:240px; height:60px;">'
		 .  '		<script type="text/javascript">'
		 .	'	googletag.cmd.push(function() { googletag.display("div-gpt-ad-1438179181782-1"); });'
		 .	'	</script>'
		 .	'	</div>	 '
	...
	$outp.= '<div class="region-titles">'
		 ...
		 .	'	 	<div id="div-gpt-ad-1438179181782-3" >'
		 .	'	 		<script type="text/javascript">'
		 .	'	 			googletag.cmd.push(function() { googletag.display("div-gpt-ad-1438179181782-3"); });'
		 .	'	 		</script>'
		 .	'	 	</div>'
		 .	'  </div>'
		 .	'  <div class="region-right">'
