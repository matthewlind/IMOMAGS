...
<?php
  ...
  window.plugin_dir_url = "'.plugin_dir_url( __FILE__ ).'";
  window.channel_taxonomy = "'.$wp_query->query_vars["channel_taxonomy"].'";
  window.channel_term = "'.$wp_query->query_vars["channel_term"].'";

  </script>';
  echo '<script type="text/javascript" src="'.plugin_dir_url( __FILE__ ).'js/imo-video-gallery.js"></script>';
