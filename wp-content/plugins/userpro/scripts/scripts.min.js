				...
				success:function(data){
					...
					statusbar.prev().fadeIn( function() {
						if (filetype == 'picture'){
							...
							statusbar.parents('.userpro-input').find('img').attr('src', data.response ).removeClass('no_feature');
...
function userpro_end_load(form) {
	...
	form.find('img.userpro-loading').hide();
...
jQuery(document).ready(function() {
	...
	**/
	jQuery(document).on('submit', '.userpro form:not(.userpro-search-form)', function(e){
		...
		if (form.data('action') != 'login' && form.data('action') != 'reset' && form.data('action') != 'delete' && form.data('action') != 'publish' ) {
			...
			success:function(data){
				...
				if (data.error){
					...
					jQuery.each( data.error, function(key, value) {
						i++;
						element = form.find('.userpro-field[data-key="'+key+'"]').find('input[type=text],input[type=password]');
	...
	**/
	jQuery(document).on('blur', '.userpro[data-template=register] input, .userpro[data-template=edit] input,  .userpro[data-template=change] input', function(e){
	...
	**/
	jQuery(document).on('click', '.userpro form:not(.userpro-search-form) .userpro-input .userpro-button.red', function(e){
		...
		jQuery(this).parents('.userpro-input').find('img.modified').remove();
			...
			jQuery(this).parents('.userpro-input').find('img.modified').attr('src', jQuery(this).parents('.userpro-input').data('placeholder') );
			} else {
