		...
		$res .= "<div class='userpro-input' data-placeholder='".userpro_url . "img/placeholder.jpg'>";
			...
			switch($key) {
				...
				case 'post_featured_image':
					$value = '<span class="userpro-pic-none">'.__('No featured image was set.','userpro').'</span><img src="'.userpro_url . 'img/placeholder.jpg" width="" height="" class="modified no_feature" />';
