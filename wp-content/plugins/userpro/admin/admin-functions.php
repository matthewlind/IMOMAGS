	...
	?>
			<div class="userpro-admin-head">
				...
				<div class="userpro-admin-right">
					<a href="http://userproplugin.com/userpro/wp-content/plugins/userpro/changelog.txt" class="button"><?php _e('Check for updates','userpro'); ?></a>
					<a href="http://userproplugin.com/userpro/forums/" class="button"><?php _e('Need Support?','userpro'); ?></a>
