...
<h3><?php _e('BuddyPress Compatibility','userpro'); ?></h3>
<table class="form-table">
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('By default, UserPro hides backend access from non-admins, however you can type a comma seperated list here of user roles to allow them to access the dashboard regardless of any other setting. example: author,editor'); ?></span>
		</td>
	</tr>
