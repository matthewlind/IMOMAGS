        ...
        <div class="dif-post-text">
            ...
            <div class="profile-panel">
                ...
                <div class="profile-data">
                    ...
                    <ul class="prof-like">
                    	<li>
                    		<div class="fb-like" data-href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/community/post/<%= post.id %>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
                    	</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="photo-link-area ask-quesiton">
            <div class="fileupload-buttonbar ">
                <label class="upload-button share-photo">
                    <a href="/community/new-post?question"><span class="add-photo-link">Ask a Question</span></a>
                </label>
            </div>
        </div>
