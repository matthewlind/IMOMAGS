    ...
    <div class="frame">
        ...
        <div class="sub-widgets">
            <div class="w-col">
                <h3>Legend</h3>
                <ul class="day-data">
                    <li class="best-p"> - Best overall time to fish this day (Daytime Major)</li>
                    <li class="major-p"> - Major Period (Moon overhead or underfoot)</li>
                    <li class="minor-p"> - Minor Period (Moon between Major Periods)</li>
                </ul>
                <div class="chart">
