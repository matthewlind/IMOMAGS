<?php
	...
	*/	
	...
	{			
		...
		$galleryId = $gallery->Id . (rand(0, 999));
		...
		foreach($imageResults as $image)
		{
			...
			$galleryImages[] = new GalleriImage($image->imagePath, $image->description, $image->title);
			$i++;
		}
...
class GalleriImage
{
	...
	public function __construct($image, $description, $title)
	{
		$this->image = $image;
