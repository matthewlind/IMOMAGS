     ...
     <div class="table better-rss-widget-settings-table">
          <table class="form-table">
               <tr align="top">
                    ...
                    <td><select name="<?php echo $this->optionsName; ?>[link_target]" id="<?php echo $this->optionsName; ?>_link_target">
                              <option>None</option>
               ...
               <tr align="top">
                    ...
                    <td><select name="<?php echo $this->optionsName; ?>[items]" id="<?php echo $this->optionsName; ?>_items">
                              <?php
                              for ( $i = 1; $i <= 20; ++$i ) echo "<option value='$i' " . ($this->options->items == $i ? "selected='selected'" : '' ) . ">$i</option>";
                              ?>
                         </select>
                    </td>
               </tr>
