...
<div class="postbox">
     ...
     <div style="padding:5px;">
          ...
          <p><span><?php _e('You are using', 'better-rss-widget'); ?> <strong> <a href="http://plugins.grandslambert.com/plugins/better-rss-widget.html" target="_blank"><?php echo $this->pluginName; ?> <?php echo $this->version; ?></a></strong> by <a href="http://grandslambert.com" target="_blank">GrandSlambert</a>.</span> </p>
     </div>
</div>
<div class="postbox">
     <h3 class="handl" style="margin:0; padding:3px;cursor:default;">
