...
function wp_about_author_general_settings(){
	...
	if ( function_exists('wp_nonce_field') ){ $general_content .= wp_nonce_field('wp-about-author-update-options','_wpnonce',true,false); }
...
function wp_about_author_process_settings() {
	if ( !empty($_POST['wp_about_author_option_submitted']) ){
		...
		if(strstr($_GET['page'],"wp-about-author") && check_admin_referer('wp-about-author-update-options')){
			...
			if ((strlen($color)==6||strlen($color) == 3)&&isset($_POST['wp_author_alert_bg'])){ $wp_about_author_settings['wp_author_alert_bg']=$_POST['wp_author_alert_bg']; }
			if(isset($_POST['wp_author_alert_border'])){ $wp_about_author_settings['wp_author_alert_border']=$_POST['wp_author_alert_border']; }
			if(isset($_POST['wp_author_display_front'])){ $wp_about_author_settings['wp_author_display_front']=$_POST['wp_author_display_front']; }
			if(isset($_POST['wp_author_display_archives'])){ $wp_about_author_settings['wp_author_display_archives']=$_POST['wp_author_display_archives']; }
			if(isset($_POST['wp_author_display_search'])){ $wp_about_author_settings['wp_author_display_search']=$_POST['wp_author_display_search']; }
			if(isset($_POST['wp_author_display_posts'])){ $wp_about_author_settings['wp_author_display_posts']=$_POST['wp_author_display_posts']; }
			if(isset($_POST['wp_author_display_pages'])){ $wp_about_author_settings['wp_author_display_pages']=$_POST['wp_author_display_pages']; }
			if(isset($_POST['wp_author_display_feed'])){ $wp_about_author_settings['wp_author_display_feed']=$_POST['wp_author_display_feed']; }
