...
function wp_about_author_display(){
	global $post;
...
function wp_about_author_scripts() {
...
function add_defaults_wp_about_author() {
    ...
    if(!is_array($tmp)) {
		...
		update_option('wp_about_author_settings', $arr);
	}
}
...
add_action('wp_print_scripts', 'wp_about_author_scripts');
