...
class imo_featured_thumbs_sidebar_widget extends WP_Widget {


    /** constructor -- name this the same as the class above */
    function imo_featured_thumbs_sidebar_widget() {
        parent::WP_Widget(false, $name = 'Featured Set Sidebar Widget (Thumbnails)');
    }
...
//array('description'=>'Shows an even number of side-by-side post thumbnails in the sidebar.')
    ...
    function form($instance) {
        ...
        function getWidgetThumbnailThumb($dataArray) {
...
add_action('widgets_init', create_function('', 'return register_widget("imo_featured_thumbs_sidebar_widget");'));
