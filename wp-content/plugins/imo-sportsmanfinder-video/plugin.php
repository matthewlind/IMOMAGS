<?php
/*
Plugin Name: IMO Sportsman Channel Finder with video player
Plugin URI: http://dev.imomags.com
Description: Creates a sportsman channel finder widget with video player for IMO sites.
Version: 1.0
Author: IMO FOX
...
/**
 * IMOSportsmanVideoWidget
 *
 * Creates the store wdiget for a page. 
 */
class IMOSportsmanVideoWidget extends \WP_Widget {

    function __construct()
    {
        parent::__construct("channel-video-widget", "Sportsman Channel Video Widget");
    }
