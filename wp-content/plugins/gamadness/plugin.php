...
function jsGAMRender() {
	...
	$outp.= '<div class="ga-madness">'
		 ...
		 .	'    <h2>Handguns</h2>'. get_imo_dart_tag("240x60",1,false,array("camp"=>"ga_madness"))
		 .	'  </div>'
		 .	'  <div class="region-right">'
		 .	'    <h2>Shotguns</h2>'. get_imo_dart_tag("240x60",1,false,array("camp"=>"ga_madness"))
		 .	'  </div>'
		 .	'</div>'
		 ...
		 .  '<div class="region-titles">'
		 .	'  <div class="region-left">'
		 .	'    <h2>Rifles</h2>'. get_imo_dart_tag("240x60",1,false,array("camp"=>"ga_madness"))
		 .	'  </div>'
		 .	'  <div class="region-right">'
		 .	'    <h2>AR-15s</h2>'. get_imo_dart_tag("240x60",1,false,array("camp"=>"ga_madness"))
		 .	'  </div>'
		 .	'</div>'
