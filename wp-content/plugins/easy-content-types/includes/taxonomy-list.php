		...
		foreach( $taxonomies as $key => $tax) {
			?>			
				<tr <?php if(ecpt_is_odd($i)) { echo 'class="alternate"'; } ?> id="ecpt-tax-<?php echo $tax->id; ?>">
					...
					<td><?php echo __('Single', 'ecpt') . ': ' . $tax->singular_name . '<br/>Plural: ' . $tax->plural_name; ?></td>
					<td>
						<ul>
						<?php
					...
					<td>
						<a href="admin.php?page=easy-content-types/easy-content-types.php?taxonomies&edit-tax=<?php echo $tax->id; ?>" title="<?php _e('edit', 'ecpt'); ?>" class="ecpt-edit-taxonomy" id="ecpt-edit-<?php echo $tax->id; ?>"><?php _e('Edit', 'ecpt'); ?></a> |
						...
						<a href="admin.php?page=easy-content-types/easy-content-types.php?taxonomies&ecpt-action=delete-taxonomy&tax-id=<?php echo $tax->id; ?>" title="<?php _e('Delete', 'ecpt'); ?>" class="ecpt-delete-taxonomy" id="ecpt-delete-<?php echo $tax->id; ?>"><?php _e('Delete', 'ecpt'); ?></a>
					</td>
				</tr>
			<?php $i++;
		}
