				...
				?>			
					<tr <?php if(ecpt_is_odd($i)) { echo 'class="alternate"'; } ?> id="ecpt-posttype-<?php echo $type->id; ?>">
						...
						<td>
							...
							<?php _e('Archives', 'ecpt'); ?>: <em>archive-<?php echo $type->name;?>.php</em><br/>
							<?php } ?>
							<?php _e('Single', 'ecpt'); ?>: <em>single-<?php echo $type->name; ?>.php</em>
						</td>
						<td>
							<a href="admin.php?page=easy-content-types/easy-content-types.php?posttypes&posttype-edit=<?php echo $type->id; ?>" title="Edit" class="ecpt-edit" id="ecpt-edit-<?php echo $type->id; ?>"><?php _e('Edit', 'ecpt'); ?></a> |
							<a href="edit.php?post_type=<?php echo $type->name; ?>" title="Edit" class="ecpt-edit" id="ecpt-edit-<?php echo $type->id; ?>"><?php _e('View', 'ecpt'); ?> <?php echo $type->plural_name; ?></a> |
							<a href="post-new.php?post_type=<?php echo $type->name; ?>" title="Edit" class="ecpt-edit" id="ecpt-edit-<?php echo $type->id; ?>"><?php _e('Add New', 'ecpt'); ?> <?php echo $type->singular_name; ?></a> |
							<a href="admin.php?page=easy-content-types/easy-content-types.php?posttypes&ecpt-action=delete-posttype&posttype-id=<?php echo $type->id; ?>" title="Delete" class="ecpt-delete ecpt-post-type-delete" id="ecpt-delete-<?php echo $type->id; ?>"><?php _e('Delete', 'ecpt'); ?></a>
						</td>
					</tr>
				<?php
				$i++;
