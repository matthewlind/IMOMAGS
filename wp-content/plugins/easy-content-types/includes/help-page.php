		...
		<div id="ecpt-wrap" class="ecpt-help-page">
			...
			<h3 id="posttypes"><?php _e('Post Types', 'ecpt'); ?></h3>
				...
				<p id="showing-posttypes" class="ecpt_title"><strong><?php _e('Querying Post Types', 'ecpt'); ?></strong> - <a href="#ecpt-wrap"><?php _e('Back To Top', 'ecpt'); ?></a></p>
					<div class="ecpt_section">
						...
						<em>
						&lt;?php 
						query_posts( array( 'post_type' => 'post_type_name', 'showposts' => 10 ) ); <br/>
			...
			<h3 id="metaboxes"><?php _e('Meta Boxes', 'ecpt'); ?></h3>
				...
				<div class="ecpt_section">
					...
					<pre>ecpt_display_meta($metabox, $type = 'all', $descriptions = true, $images = true, $dateformat = 'F j, Y', $blank = false, $repeatable_iamges = false)</pre>
					<ul>
						...
						<li>$repeatable_iamges - this determines whether images in repeatable upload fields should be rendered, or left as file URLs</li>
					</ul>
