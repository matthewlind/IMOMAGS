	...
	<div class="wrap">
		<div id="ecpt-wrap" class="ecpt-help">
			...
			<form method="post" action="options.php">
				...
				<?php } ?>
				<p><strong><?php _e('Note', 'ecpt'); ?></strong>: <?php _e('If you want more control over how meta field values are displayed, use the <a href="http://localhost/wordpress/wp-admin/admin.php?page=easy-content-types/easy-content-types.php?help#field-info">ecpt_display_meta()</a> function in your template files, or one of the other methods described in the documentation.', 'ecpt'); ?></p>
