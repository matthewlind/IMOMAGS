...
<div class="category-page">
	...
	<?php
		...
		if (!$useNetworkFeed) {
			...
			?>
				<div class="category-cross-site-feed" term="<?php echo $categorySlug; ?>"><!-- This term= attribute is searched for --></div>
				<div class="category-cross-site-feed-more-button">
...
<article id="category-excerpt-template" class="post type-post status-publish format-standard hentry entry entry-excerpt has-img" style="display:none;">
