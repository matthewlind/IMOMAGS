...
class GFUser {
        ...
        <form method="post" action="" id="gf_user_form">
            ...
            <div class="margin_vertical_10<?php echo $is_validation_error ? " user_registration_validation_error" : "" ?>">
                ...
                if($is_validation_error){
                    ?>
                    <span><?php _e('Your Registration Feed could not be saved. Please update the errors below and re-save your feed.'); ?></span>
                    <?php
                }
                ?>
    ...
    public static function user_registration_validation($validation_result){
        ...
        $user_name = self::get_prepared_value($username_field, $config['meta']['username'], $entry, true);
