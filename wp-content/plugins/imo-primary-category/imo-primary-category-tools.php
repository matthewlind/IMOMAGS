...
/**
	Tools is a class that collects many tools, functions and codes.
	
	It's meant to be a virtual class, from which I extend my classes and  use its code.

	version 0.28 20100621
*/
...
<style type="text/css">
	...
	.hikari-postbox{ width: 80%; position: static; }
	.hikari-uninstall-form{ margin-top: 3em; }
	.hikari-uninstall-table{ clear: none; width: 80%; }
</style>
<?php	}
