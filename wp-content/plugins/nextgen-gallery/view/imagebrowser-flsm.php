...
<div class="ngg-imagebrowser" id="<?php echo $image->anchor ?>">
	...
	<div class="ngg-imagebrowser-nav"> 
		<div class="back">
			<a class="ngg-browser-prev" id="ngg-prev-<?php echo $image->previous_pid ?>" href="<?php echo $image->previous_image_link ?>#controls">&#9668; <?php _e('Back', 'nggallery') ?></a>
		</div>
		<div class="next">
			<a class="ngg-browser-next" id="ngg-next-<?php echo $image->next_pid ?>" href="<?php echo $image->next_image_link ?>#controls"><?php _e('Next', 'nggallery') ?> &#9658;</a>
		</div>
		<div class="ngg-imagebrowser-desc"><h3><?php echo $image->alttext ?></h3><p align=center><?php echo $image->description ?></p></div>
	</div>	
