...
<!-- END 728x90 Ad: -->
	...
	<header id="header">
			...
			<div style="float:right;padding-top:30px;width:240px;">
				<div style="float:right;p">
                                        <a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0141D&i4Ky=IBZN"><img style="border: 1px solid #cccccc;" width="83px" src="http://dev.imomags.com/imgs/bowhunter-magazine.png"></a> 
                                 </div> 
				<div style="float:left; adding-right:10px;margin-right:10px;text-align:right;">
					...
					<p style="margin-bottom:2px;margin-top:10px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0141D&i4Ky=IBZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscribe Now!</a></p> 
					<p style="margin-bottom:2px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0141D&i4Ky=IBZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Give a Gift</a></p> 
					<p><a href="https://secure.palmcoastd.com/pcd/eServ?iServ=MDE0MUQ0NDcwMCZpVHlwZT1FTlRFUg==" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscriber Services</a></p> 
				</div>	
