...
<!-- +++++++++ IMO MODS ++++++++ -->
  ...
  _gaq.push(['_setAccount', 'UA-2409437-16']);
  _gaq.push(['_setDomainName', '.rifleshootermag.com']);
  _gaq.push(['_trackPageview']);
	...
	<header id="header">
			...
			<div style="float:right;padding-top:20px;width:240px;">
				<div style="float:right;p">
                                        <a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0145Y&i4Ky=IBZN"><img style="border: 1px solid #cccccc;" width="83px" src="http://dev.imomags.com/imgs/rifleshooter-magazine.png"></a> 
                                 </div> 
				<div style="float:left; adding-right:10px;margin-right:10px;text-align:right;">
					<p style="FONT-WEIGHT: bold; COLOR:#cccccc;line-height:13px;">Save Over 65% off<br> the Cover Price </p> 
					<p style="margin-bottom:2px;margin-top:10px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0145Y&i4Ky=IBZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscribe Now!</a></p> 
					<p style="margin-bottom:2px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0145Y&i4Ky=IGZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Give a Gift</a></p> 
					<p><a href="https://secure.palmcoastd.com/pcd/eServ?iServ=MDE0NVk0NDc3NSZpVHlwZT1FTlRFUg==" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscriber Services</a></p> 
				</div>	
