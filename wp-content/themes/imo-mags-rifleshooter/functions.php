...
function custom_gun_terminology_checklist($post_id = 0, $args = array()) {
        ...
        $ammunition = get_term_by( 'slug', 'ammunition', 'category' );
	    ...
	    $include = array(
	        ...
	        $ballistics->term_id,$ammunition->term_id,$airguns->term_id,$riflescopes->term_id
	    );
...
function custom_topics_checklist($post_id = 0, $args = array()) {
		    ...
		    $accuracy = get_term_by( 'slug', 'accuracy-tests', 'category' );
		    ...
		    $include = array(
		        ...
		        $second_amendment->term_id,$shooting_tips->term_id,$hunting->term_id,$accuracy->term_id
		    );
