...
function custom_gun_terminology_checklist($post_id = 0, $args = array()) {
	    ...
	    $include = array(
	        ...
	        $ballistics->term_id,$long_guns->term_id,$muzzleloaders->term_id,$reloading->term_id
	    );
...
function custom_topics_checklist($post_id = 0, $args = array()) {
	        ...
	        $how_to = get_term_by( 'slug', 'how-to', 'category' );
		    ...
		    $include = array(
		        ...
		        $competition->term_id,$politics->term_id,$carry->term_id,$how_to->term_id,
		        $second_amendment->term_id,$gunsmith->term_id,$hunting->term_id,$zombies->term_id,$tactical->term_id,$culture->term_id
		    );
