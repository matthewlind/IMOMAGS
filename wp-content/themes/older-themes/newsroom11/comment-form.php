...
<form class="bandit-form fix" action="<?php echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="respond">
	...
	<header class="header-comments"> 
		<h4 class="heading"><span><?php _e('Leave a comment','newsroom'); ?></span></h4>
	...
	<ul class="fix">
		<li class="leftThird">
			<label for="author" class="desc"><?php _e('Name','newsroom'); ?>
				<span class="req">*</span>
			</label>
			<div>
		...
		<li class="middleThird">
			<label for="email" class="desc"><?php _e('Email','newsroom'); ?>
				<span class="req">*</span>
			</label>
			<div>
		...
		<li class="rightThird">
			<label for="url" class="desc"><?php _e('Website','newsroom'); ?></label>
			<div>
...
<?php endif; ?>
		...
		<li class="buttons">
			<div>
				<input id="saveForm" name="saveForm" class="btTxt submit" type="submit" value="<?php _e('Submit','newsroom'); ?>" />
			</div>
		</li>
	</ul>
