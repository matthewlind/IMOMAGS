...
if (!class_exists('cfct_module_featured_thumbs') && class_exists('cfct_build_module')) {
	class cfct_module_featured_thumbs extends cfct_build_module {
		...
		public function __construct() {
			...
			parent::__construct('cfct-module-featured-thumbs', __('Featured Thumbs', 'carrington-build'), $opts);
...
// Content Move Helpers
	...
	cfct_build_register_module('cfct_module_featured_thumbs');
}
?>