...
if (!class_exists('cfct_module_slideshow_html')) {
	/**
	 ...
	 */
	class cfct_module_slideshow_html extends cfct_build_module {
		protected $_deprecated_id = 'cfct-html'; // deprecated property, not needed for new module development

		public function __construct() {
			$opts = array(
				'description' => __('Use with slideshow.', 'carrington-build'),
				'icon' => 'html/icon.png'
			);
			parent::__construct('cfct-slideshow-html', __('SLIDESHOW', 'carrington-build'), $opts);
		}
	...
	cfct_build_register_module('cfct_module_slideshow_html');
}
?>