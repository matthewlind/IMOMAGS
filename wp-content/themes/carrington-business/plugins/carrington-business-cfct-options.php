...
// Custom theme based options additions for Carrington Build to accompany the Carrington Business Theme
...
function cfct_module_admin_theme_style_images($type) {
	...
	$options['cfct_module_callout'] = $module_options['post_callout_module'];
	// headings
...
function cfct_module_admin_theme_chooser($form_html, $data) {
	...
	$form_html .= '
				...
				<div id="cfct-theme-select-images-wrapper">
					<h4>'.__('Select a style...', 'carrington-business').'</h4>
