...
<div class="content">
  ...
  <h1 style="margin-bottom:20px">Unfortunately, We couldn't find any results that matched your request. Here are the latest stories from <?php echo get_bloginfo("name"); ?></h1>
