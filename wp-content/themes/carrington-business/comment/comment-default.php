...
?>
<div class="notice">
	<div class="content"><?php _e('Your comment is awaiting moderation.', 'carrington-business'); ?></div>
</div>
<?php 
}
?>
<div id="comment-<?php comment_ID(); ?>" <?php comment_class('reply clearfix'); ?>>
	...
	<div class="reply-footer">
		...
		edit_comment_link(__('Edit', 'carrington-business'), ' <span class="spacer">&bull;</span> ', '');
		?>
	</div>
</div><!-- .reply -->