...
function custom_terms_checklist($post_id = 0, $args = array()) {
		    ...
		    $include = array(
		        ...
		        $carry_on->term_id,$firing_line->term_id,$sixguns_sagebrush->term_id,
		        $video->term_id,$pdtv->term_id
		    );
...
function custom_gun_terminology_checklist($post_id = 0, $args = array()) {
        ...
        $pistols = get_term_by( 'slug', 'pistols', 'category' );
	    ...
	    $include = array(
	        ...
	        $optics->term_id,$ballistics->term_id,$pistols->term_id
	    );
...
function custom_topics_checklist($post_id = 0, $args = array()) {
		    ...
		    $shooting_tips = get_term_by( 'slug', 'shooting-tips', 'category' );
		    $second_amendment = get_term_by( 'slug', 'second-amendment', 'category' );
		    $tactics = get_term_by( 'slug', 'tactics-and-training', 'category' );
		    $airguns = get_term_by( 'slug', 'airguns', 'category' );
		    ...
		    $include = array(
		        ...
		        $second_amendment->term_id,$shooting_tips->term_id,$tactics->term_id,$airguns->term_id
		    );
