 ...
 * Description: The NAW+ Community - Trophy Category
 *
...
<div class="col-abc super-post">
    <header class="header-title">
		...
		<h1><a href="/community/">Community</a> <span>| Trophy Bucks</span></h1>
	</header>
	<div class="col-abc super-post">
	    ...
	    <ul class="post-type-select add-post" style="<?php echo $displayStyle; ?>">
	    	<li id="new-post-button" class="new-post post trophy">+ POST IN TROPHY BUCKS</li>
		</ul>

        <div id="recon-activity" term="trophy" display="tile">
