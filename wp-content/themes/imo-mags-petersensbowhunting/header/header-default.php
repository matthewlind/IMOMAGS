...
<!-- +++++++++ IMO MODS ++++++++ -->
  ...
  _gaq.push(['_setAccount', 'UA-2409437-7']);
  _gaq.push(['_setDomainName', '.bowhuntingmag.com']);
  _gaq.push(['_trackPageview']);
	...
	<header id="header">
			...
			<div style="float:right;padding-top:10px;width:240px;">
				<div style="float:right;p">
                                        <a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0144Z&i4Ky=IBZN"><img style="border: 1px solid #cccccc;" width="83px" src="http://dev.imomags.com/imgs/petersensbowhunting-magazine.png"></a> 
                                 </div> 
				<div style="float:left; adding-right:10px;margin-right:10px;text-align:right;">
					...
					<p style="margin-bottom:2px;margin-top:10px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0144Z&i4Ky=IBZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscribe Now!</a></p> 
					<p style="margin-bottom:2px;"><a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0144Z&i4Ky=IBZN" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Give a Gift</a></p> 
					<p><a href="https://secure.palmcoastd.com/pcd/eServ?iServ=MDE0NFo0NDc2OCZpVHlwZT1FTlRFUg==" style="FONT-WEIGHT: bold; COLOR: #ffffff; TEXT-DECORATION: none">Subscriber Services</a></p> 
				</div>	
