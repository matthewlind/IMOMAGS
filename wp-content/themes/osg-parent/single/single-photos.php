	...
	<article id="article" class="article">
		...
		<div class="article-body">
			<div id="sticky-ad" class="sticky-ad">
			    <div class="sticky-ad-inner"><?php imo_ad_placement("sticky"); ?></div>
		    </div>
			<div class="feat-img">
	        ...
	        <div class="photo-text">
	            ...
	            if(get_post_meta($post_id,"camera_corner_taken",true)){ ?>
					<ul>
		                <li><b>Taken At: </b><?php echo get_post_meta($post_id,"camera_corner_taken",true); ?></li>
		                <li><b>Taken On: </b><?php echo get_post_meta($post_id,"camera_corner_when",true); ?></li>
		                <li><b>With: </b><?php echo get_post_meta($post_id,"camera_corner_who",true); ?></li>
		            </ul> 
				<?php } ?>
		        </div>
		</div>
...
<div id="more_stories" class="more-stories">
	...
	<div id="btn_more_stories" class="btn-lg" data-cat="<?php echo $primary_cat_id; ?>" data-post-type="<?php echo $post_type; ?>" data-post-not="<?php echo $post_id; ?>" data-fb-like="1">
		<span>Show More</span>
