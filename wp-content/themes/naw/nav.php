<div class="community-header">
	...
	<div class="header-section menu-main">
		<ul class="">
			<li class="sub-list"><a href="/photos?rut-report" class="photo-menu" slug="rut-report">Rut Report</a></li>
			<li class="sub-list"><a href="/photos?general-discussion" class="photo-menu" slug="general-discussion">General Discusion</a></li>
			<li class="sub-list"><a href="/photos?question" class="photo-menu" slug="question">Q&A</a></li>	
		</ul>
	</div>
