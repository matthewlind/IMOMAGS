 ...
 * head-include.php
 *
 * All customizations per hme on a site.
 */
...
?>
	<meta name="apple-itunes-app" content="app-id=580253945">
	<!-- FONTS -->
  ...
  _gaq.push(['_setAccount', 'UA-2409437-2']);
  _gaq.push(['_setDomainName', '.floridasportsman.com']);
  <?php
  	if (is_single()) {
...
if(document.location.protocol=='http:'){
 var Tynt=Tynt||[];Tynt.push('cRpvC4Xzar36caadbi-bnq');
