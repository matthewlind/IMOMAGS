...
<header id="masthead" class="reeltime-header">
	<a href="/rtfs/" title="Reel Time with Florida Sportsman"><h1 class="reeltime-title"><?php the_title(); ?></h1></a>
	
</header><!-- #masthead -->

<nav class="nav nav-secondary"><!--new REEL TIME MENU-->
	
	<?php wp_nav_menu( array( 'theme_location' => 'reeltime-menu', 'fallback_cb' => '' ) ); ?>
