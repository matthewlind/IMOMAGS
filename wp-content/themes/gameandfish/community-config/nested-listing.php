<?php
	...
	$IMO_COMMUNITY_CONFIG['page_type'] = 'nested-listing';//Nested listings utilize a nested taxonomy for routing
	$IMO_COMMUNITY_CONFIG['page_title'] = 'Game & Fish Community';
	$IMO_COMMUNITY_CONFIG['template'] = '/gameandfish/listing.php';
	$IMO_COMMUNITY_CONFIG['template_single'] = '/gameandfish/single.php';
	...
	$IMO_COMMUNITY['photos-main'] = $IMO_COMMUNITY_CONFIG;
?>