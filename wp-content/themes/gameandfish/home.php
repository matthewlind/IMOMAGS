        ...
        <div class="general-frame">
            ...
            <?php if ( is_home() ) : ?>
               ...
               <!-- <a data-position="<?php echo $dataPos = $dataPos + 1; ?>" class="subscribe-banner subscribe-banner-top js-responsive-section" href="#">
                ...
                <?php $fetured_slider_query = new WP_Query( 'category_name=fishing&posts_per_page=8' ); ?>
				...
				<?php $fetured_slider_query = new WP_Query( 'category_name=hunting&posts_per_page=8' ); ?>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="single-post-slider loading-block">
                            ...
                            <div class="post-panel clearfix">
                                <a class="see-all" href="/reader-photos/">See All </a>
                            </div>
                        </div>
