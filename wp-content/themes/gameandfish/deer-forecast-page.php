...
<?php if(mobile() == true || tablet() == true){ ?>
	...
	<select name="menu4">
		<option value="">Select Your State</option>
		<option value="/deer-forecast/alabama-deer-forecast-2014">alabama</option>
		<option value="/deer-forecast/rocky-mountain-deer-forecast-2014">arizona</option>
		<option value="/deer-forecast/arkansas-deer-forecast-2014">arkansas</option>
		<option value="/deer-forecast/california-deer-forecast-2014">california</option>
		<option value="/deer-forecast/new-england-deer-forecast-2014">connecticut</option>
		<option value="/deer-forecast/rocky-mountain-deer-forecast-2014">colorado</option>
		<option value="/deer-forecast/florida-deer-forecast-2014">florida</option>
		<option value="/deer-forecast/georgia-deer-forecast-2014">georgia</option>
		<option value="/deer-forecast/idaho-deer-forecast-2014">idaho</option>
		<option value="/deer-forecast/illinois-deer-forecast-2014">illinois</option>
		<option value="/deer-forecast/indiana-deer-forecast-2014">indiana</option>
		<option value="/deer-forecast/iowa-deer-forecast-2014">iowa</option>
		<option value="/deer-forecast/great-plains-deer-forecast-2014">kansas</option>
		<option value="/deer-forecast/kentucky-deer-forecast-2014">kentucky</option>
		<option value="/deer-forecast/louisiana-deer-forecast-2014">louisiana</option>
		<option value="/deer-forecast/maine-deer-forecast-2014">maine</option>
		<option value="/deer-forecast/new-england-deer-forecast-2014">massachusetts</option>
		<option value="/deer-forecast/michigan-deer-forecast-2014">michigan</option>
		<option value="/deer-forecast/minnesota-deer-forecast-2014">minnesota</option>
		<option value="/deer-forecast/mississippi-deer-forecast-2014">mississippi</option>
		<option value="/deer-forecast/missouri-deer-forecast-2014">missouri</option>
		<option value="/deer-forecast/great-plains-deer-forecast-2014">nebraska</option>
		<option value="/deer-forecast/new-england-deer-forecast-2014">new hampshire</option>
		<option value="/deer-forecast/rocky-mountain-deer-forecast-2014">new mexico</option>
		<option value="/deer-forecast/new-york-deer-forecast-2014">new york</option>
		<option value="/deer-forecast/north-carolina-deer-forecast-2014">north carolina</option>
		<option value="/deer-forecast/great-plains-deer-forecast-2014">north dakota</option>
		<option value="/deer-forecast/ohio-deer-forecast-2014">ohio</option>
		<option value="/deer-forecast/oklahoma-deer-forecast-2014">oklahoma</option>
		<option value="/deer-forecast/washington-oregon-deer-forecast-2014">oregon</option>
		<option value="/deer-forecast/pennsylvania-deer-forecast-2014">pennsylvania</option>
		<option value="/deer-forecast/new-england-deer-forecast-2014">rhode island</option>
		<option value="/deer-forecast/south-carolina-deer-forecast-2014">south carolina</option>
		<option value="/deer-forecast/great-plains-deer-forecast-2014">south dakota</option>
		<option value="/deer-forecast/tennessee-deer-forecast-2014">tennessee</option>
		<option value="/deer-forecast/texas-deer-forecast-2014">texas</option>
		<option value="/deer-forecast/vermont-deer-forecast-2014">vermont</option>
		<option value="/deer-forecast/virginia-deer-forecast-2014">virginia</option>
		<option value="/deer-forecast/washington-oregon-deer-forecast-2014">washington</option>
		<option value="/deer-forecast/west-virginia-deer-forecast-2014">west virginia</option>
		<option value="/deer-forecast/wisconsin-deer-forecast-2014">wisconsin</option>		
		<option value="/deer-forecast/rocky-mountain-deer-forecast-2014">Wyoming</option>
	</select>
	<input type="button" name="Submit" value="Go" class="forecast-submit" onClick="window.location = this.form.menu4.options[this.form.menu4.selectedIndex].value;">
	</form>
