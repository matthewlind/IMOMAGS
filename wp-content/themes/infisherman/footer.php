...
<div id="footer" class="footer" role="contentinfo">
                ...
                <div class="foot-columns">
                    ...
                    <div class="f-two-columns">
                        <div class="column column3">
                            <h5>Fish</h5>
                            <ul class="intermedia-list">
                                <li><a href="/"><img src="<?php bloginfo('template_directory'); ?>/images/logos/fish-infisherman.png" alt=""><span>In-Fisherman</span></a></li>
        ...
        <div class="copyright-section clearfix">
            ...
            <div class="foot-sub-logos">
                ...
                <img class="sub-logo" src="<?php bloginfo('template_directory'); ?>/images/logos/msn.png" alt="">
            </div>
        </div>
	...
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/plugins/flexslider/jquery.flexslider-min.js"></script>
    ...
    <!-- ***crashes ad scripts*** <script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/blocks-reorder.js"></script>-->
