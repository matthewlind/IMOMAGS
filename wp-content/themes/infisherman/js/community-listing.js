...
/**
 * Photo Slider
 * @url    : http://www.in-fisherman.fox/photos/
...
jQuery( document ).ready(function( $ ) {
	...
	var PhotosGallery = (function(){
		...
		Private = {
			...
			url          : 'http://www.in-fisherman.fox/wpdb/network-feed-cached.php',
			state        : function(){								
			...
			templateSlide : function(v){
				...
				if (window.location.host != "www.in-fisherman.fox") {

					v.img_url = v.img_url.replace("www.in-fisherman.fox",window.location.host);
				};
			...
			templateThumbs : function(v){
				...
				if (window.location.host != "www.in-fisherman.fox") {
					...
					v.thumb = v.thumb.replace("www.in-fisherman.fox",window.location.host);
				};
