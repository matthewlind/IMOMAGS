...
<meta name="viewport" content="width=320.1, initial-scale=1, user-scalable=no">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/h/apple-touch-icon.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/m/apple-touch-icon.png">
    <link rel="apple-touch-icon-precomposed" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/l/apple-touch-icon-precomposed.png">



    <link rel="apple-touch-startup-image" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/startup_iphone5.jpg" media="screen and (device-height: 568px)">
    <link rel="apple-touch-startup-image" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/startup_iphone4.jpg" media="screen and (device-height: 480px) and (min-device-pixel-ratio: 2)">
    <link rel="apple-touch-startup-image" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/startup_iphone4.jpg" media="screen and (device-height: 480px)">



    <link rel="shortcut icon" href="wp-content/plugins/solunar-calendar/solunar-mobile/images/l/apple-touch-icon.png">
    <link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />


    <link rel="stylesheet" href="wp-content/plugins/solunar-calendar/solunar-mobile/css/styles.css">
...
<!-- End comScore Tag -->
<script type='text/javascript' src='/wp-content/plugins/solunar-calendar/solunar/js/googletag.js?ver=1.0'></script>
...
<div class="wood-bg form-bg">
    <div class="wrapper">
        <div class="solunar-cal">
            ...
            <div class="presented-by">
                <span>brought to you by</span><a href="http://www.lazertrokar.com"><img height="30" alt="cabelas" src="wp-content/plugins/solunar-calendar/solunar-mobile/images/trokar.png"></a>
            </div>
    ...
    <div class="popup install-popup" style="display:none;">
        <img class="popup-icon" src="/wp-content/plugins/solunar-calendar/solunar-mobile/images/h/apple-touch-icon.png" width="70" height="65" alt="" />
    ...
    <script type="text/template" id="mini-day-template">
        ...
        <div class="fishday jq-expand-day fishday-level<%= data.peakcode %> <%= data.today %>">
            <a href="#cal-item-<%= data.day %>" class="a-event jq-expand-link date-scroll-link">
                ...
                <span class="ico-solunar"><img src="wp-content/plugins/solunar-calendar/solunar-mobile/images/ico/cal<%= data.mooncode %>.png" width="16" height="16" alt="" /></span>
...
<script type="text/template" id="full-day-template">
  ...
  <!--                           <ul class="phase-data weather-data">
                    ...
                    <img class="moon-ico" src="wp-content/plugins/solunar-calendar/solunar-mobile/images/ico/moon<%= data.mooncode %>.png" width="36" height="35" alt="" />
        ...
        <div class="main">
            <div class="expand-posts">
                <ul class="post-list" id="related-fishing-posts">
                    <li class="post clearfix">
                        <a href="#" class="post-thumb"><img src="wp-content/plugins/solunar-calendar/solunar-mobile/images/photo/night-fishing.jpg" width="84" height="56" alt="" /></a>
                        <div class="post-text">
                    ...
                    <li class="post clearfix">
                        <a href="#" class="post-thumb"><img src="wp-content/plugins/solunar-calendar/solunar-mobile/images/photo/stealth.jpg" width="84" height="56" alt="" /></a>
                        <div class="post-text">
                    ...
                    <li class="post clearfix">
                        <a href="#" class="post-thumb"><img src="wp-content/plugins/solunar-calendar/solunar-mobile/images/photo/target-tyee.jpg" width="84" height="56" alt="" /></a>
                        <div class="post-text">
            ...
            <div class="main-content-area">
                ...
                <div class="month-heading">
                    ...
                    <h2><a href="#" class="jq-view-month"><span class="month-name">September</span> <img height=20 width=20 src="wp-content/plugins/solunar-calendar/solunar-mobile/images/ico/arrow_down.png"></a></h2>
                </div>
                            ...
                            <td>
                                <div class="fishday-red jq-expand-day">
                                    <a href="#day1" class="a-event jq-expand-link">
                                        ...
                                        <span class="ico-solunar"><img src="wp-content/plugins/solunar-calendar/solunar-mobile/images/ico/moon-small.png" width="16" height="16" alt="" /></span>
...
<!--                 <li class="minor-p">=  Good Time to Fish</li> -->
            ...
            <div class="chart">
                    <img src="wp-content/plugins/solunar-calendar/solunar/images/fishing-chart.png" width="206" height="16" alt="">
                    <div class="clearfix">
...
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/libs/jquery-2.0.1.min.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/plugins/zfselect/js/jquery.mousewheel.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/plugins/zfselect/js/jquery.zfselect.min.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/plugins/ezMark/js/jquery.ezmark.min.js"></script>
<link rel="stylesheet" href="wp-content/plugins/solunar-calendar/solunar-mobile/js/plugins/zfselect/css/zfselect.css">
<link rel="stylesheet" href="wp-content/plugins/solunar-calendar/solunar-mobile/js/plugins/ezMark/css/ezmark.css">
<script type='text/javascript' src='/wp-content/plugins/solunar-calendar/solunar/js/lodash.min.js?ver=1.0'></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/libs/jquery.cookie.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/helper.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/script.js"></script>
<script src="wp-content/plugins/solunar-calendar/solunar-mobile/js/app.js"></script>
